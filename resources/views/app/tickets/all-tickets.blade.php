                    ...
                    <form method="GET" action="/tickets/all">
                         ...
                         <div class="input-group">                               
                              ...
                              <span class="input-group-btn">
                                   @if(isset($search))
                                        <a href="/tickets/all" class="btn btn-default" title="Clear Search"><i class="fa fa-times"></i></a>
                                   @endif
                    ...
                    <div class="table table-responsive">
                         <table class="table table-striped table-hover show-pointer">
                              ...
                              <tbody>
                                   ...
                                   <tr data-target=".{{ $ticket->id }}" class="show-hand">
                                        ...
                                        <td v-on:click="showTicket({{$ticket->id}})">@if($ticket->assignedTo) {{$ticket->assignedTo->first_name}} {{$ticket->assignedTo->last_name}} @else <strong>Not Assigned</strong> @endif</td>
