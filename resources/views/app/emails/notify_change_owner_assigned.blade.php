...
<table id="mainTable" cellpadding="10">
	...
	<tr>
		<td style="font-size: small; font-weight: bold;">
			Change Ticket #{{$ticket->id}} has been assigned to you by {!!$ticket->createdBy->first_name!!} {!!$ticket->createdBy->last_name!!}
		</td>
	</tr>
...
<tr>
	<td>
		<table>
			<tr>
				<td>You may now begin work or assign work orders to implement this change.</td>
			</tr>
			<tr>
				<td>
					<table>
