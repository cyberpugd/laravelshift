...
<table id="mainTable" cellpadding="10">
	<tr>
		<td>Hi {!!$ticket->agent->first_name!!},</td>
	</tr>
	<tr>
		<td style="font-size: small; font-weight: bold;">Work Order #{{$work_order->id}} on Ticket #{{$ticket->id}} has been closed by {!!$work_order->assignedTo->first_name!!} {!!$work_order->assignedTo->last_name!!}.</td>
	</tr>
