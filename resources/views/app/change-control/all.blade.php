...
<section class="content-header">
     <h1>All Change Tickets</h1>
</section>
<section class="content">
     <div class="panel panel-default">
               <div class="panel-heading">
                                   <div class="col-md-6">
                    <form method="GET" action="/change-control/all">
                         ...
                         <div class="input-group">                               
                              ...
                              <span class="input-group-btn">
                                   @if(isset($search))
                                        <a href="/change-control/all" class="btn btn-default" title="Clear Search"><i class="fa fa-times"></i></a>
                                   @endif
                         ...
                         <table class="table table-striped table-hover show-pointer">
                              ...
                              <tbody>
                                   ...
                                   <tr data-toggle="collapse" data-target=".{{ $ticket->id }}" class="show-hand">
                                        <td><a href="/change-control/{{$ticket->id}}" target="_blank">{{$ticket->id}}</a></td>
