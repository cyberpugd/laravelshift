...
class CloseChangeTicketTest extends TestCase
{
    ...
    public function all_work_orders_must_be_closed_when_closing_change_tickets()
    {
          ...
          $this->visit('/change-control/close/'.$changeTicket->id);
          // $this->click('Close Change Ticket');
          $this->see('All work orders must be closed before closing a ticket.');
